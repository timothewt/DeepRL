...
class A2C(Algorithm):
	...
	For continuous action spaces, use A2CContinuous, and for masked	discrete action spaces use A2CMasked.
	...
	def __init__(self, config: dict[str | Any]):
		...
		assert isinstance(self.env_act_space, spaces.Discrete), \
			"Only discrete action spaces are supported. For continuous spaces, see A2CContinuous"
		if self.is_multi_agents:
