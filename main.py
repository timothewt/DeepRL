...
if __name__ == "__main__":
	...
	algo = PPOMultiDiscreteMasked(config={
		...
		"env_fn": lambda: GridWorldMAEnv(width=16, height=16, agents_nb=4),
		"num_envs": 2,
	...
	algo.load_models(r"C:\Users\AT82790\Documents\DeepRL\saved_models\PPO-GridWorldMAEnv-v0-25-10-23_10h26m19")

	# algo.train(max_steps=16_000, save_models=True, checkpoints=False)
	...
	env = ss.pettingzoo_env_to_vec_env_v1(GridWorldMAEnv(width=16, height=16, agents_nb=4, render_mode="human"))
